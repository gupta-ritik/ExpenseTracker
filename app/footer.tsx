...
const Footer = () => {
  return (
    <>
      <footer className="relative z-10 bg-gray-900 text-white pb-10 pt-20 dark:bg-dark lg:pb-20 lg:pt-[120px]">
        <div className="container">
          ...
          />
                ...
                <p className="mb-7 text-base text-body-color text-white">
